    ...
    */
            ...
            if(events[i].event_subtitle != null) {
                document.getElementById(titleId + "_created").innerHTML = "<p><b>" + events[i].event_title + "</b><br><p style='font-size: 15px; margin-top: 0px'>"+events[i].event_subtitle+"</p></p>";
            } else {
        ...
        if (internetStatus == "online") {
            ...
            if (elementId != "meglepi_description") {
                if ((gameLiveStatus == 493057) & (pubgStatAvailable == 1) & (i == 0) & (liveStatus == "live") & ((liveTimestamp < streamEndZeroElement + 3000) & (liveTimestamp > streamStartZeroElement - 3000))) {
                    ...
                    if (themeStatus == "light") {
                        document.getElementById(elementId).innerHTML = "<iframe frameborder=\"0\"scrolling=\"no\"id=\"<channel>\"src=\"https://www.twitch.tv/embed/" + streamer + "/chat?parent=dani0001414.github.io\"height=\"500px\"width=\"320px\"></iframe>";
                    } else {
                        document.getElementById(elementId).innerHTML = "<iframe frameborder=\"0\"scrolling=\"no\"id=\"<channel>\"src=\"https://www.twitch.tv/embed/" + streamer + "/chat?parent=dani0001414.github.io&darkpopout\"height=\"500px\"width=\"320px\"></iframe>";
                    }
                    gameLiveStatus = liveData.data['0'].game_id;
